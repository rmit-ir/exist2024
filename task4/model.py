...
class CLIP(nn.Module):
    def __init__(self, args):
        ...
        self.config = BertConfig.from_pretrained('bert-base-multilingual-uncased') ##minh co the doi thanh cua ANgle 
    ...
    def forward(self, inputs, labels):
        ...
        logits_text = self.classifier_text(text_feature) #self.classifier_text = nn.Linear(args.text_size, args.label_number)
